...
/**
 * The following two functions are used to create separate sets of settings for each experiment 
 * section, when relevant. Since there is only one set of settings needed for this experiment, they 
 * are not used. They may be useful in more complex experiments, however, where different sections 
 * of the experiment require different versions of the same settings. For instance, if two 
 * different sections of this experiment needed different response_time settings, we would use the 
 * following functions.
 */
 ...
 */
// TODO: This is commented out in #88, is it needed?
