...
/* Pieces of the Firestore database path. */
...
// TODO: Use a DEV enfironment variable?
...
const initParticipantFirestore = (participantId, studyId, startDate) => {
  ...
  return db.collection(RESPONSE_COLLECTION_NAME)
    ...
    .doc(startDate)
    .set({ 
      // Initialize fields for the trial
      start_time: startDate, 
      // TODO: appVersion and platform are deprecated
...
const addToFirebase = (data) => {
  ...
  db.collection(RESPONSE_COLLECTION_NAME)
    ...
    .then(() => true)
    .catch(error => {
      console.error("Error in saving data to Firebase:", error)
      return false
    })
};
